...
const Input: FC<InputProps> = ({ placeholder, required, error, onChange }) => {
  ...
  return (
    <input type='text' className={ error ? styleTwo : styleOne} placeholder={placeholder} required={required} onChange={onChange} />
  )
}
